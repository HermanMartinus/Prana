...
public class SoundManager : MonoBehaviour
{
    ...
    {
        StartCoroutine(Play(soundEffects.Find((soundEffect) => soundEffect.name == name), timeDelay, volume, pitch));
    }

    // Play a single clip through the sound effects source.
    IEnumerator Play(AudioClip clip, float timeDelay, float volume, float pitch)
    {
